...
[Xw,Xnew] = ms_scenario(X,'ms','random','missing_rate',ratio);
XX= double(X);
...
[B,S,U1,U2,U3] = HOSVD1(GXY,10,25,214);
...
for k=1:1500
    ...
    S = tensor(g(1:r1),[10,25,214]);
    U1 = reshape(g(r1+1:r1+r2),[15,10]);
    U2 = reshape(g(r1+r2+1:r1+r2+r3),[28,25]);
    U3 = reshape(g(r1+r2+r3+1:r1+r2+r3+r4),[288,214]);
